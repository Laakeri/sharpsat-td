...
void NewComponentAnalyzer<T_num>::initialize(LiteralIndexedVector<Literal> & literals,
...
template <class T_num>
void NewComponentAnalyzer<T_num>::recordComponentOf(const VariableIndex var) {
